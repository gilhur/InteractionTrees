...
Proof.
  ...
  revert ca; clear; gcofix self; intro ca.
  rewrite unfold_loop'; unfold loop_once.
...
Proof.
  ...
  clear a Hl Hr.
  unfold ITree.map.
  revert inla inra Hlr; gcofix self; intros.
  rewrite 2 unfold_loop'; unfold loop_once.
  rewrite bind_bind.
...
Proof.
  ...
  revert ca; gcofix self; intros.
  rewrite 2 unfold_loop'; unfold loop_once.
  gclo eq_itree_clo_bind; econstructor; try auto.
  intros [c | b]; intros; subst; gstep; constructor; auto with paco.
Qed.
...
Proof.
  ...
  - eapply monotone_suttF.
    ...
    + intros ? ? []. gbase. eapply self; eauto.
  - gunfold Hu.
    rewrite unfold_bind in H1.
    rewrite unfold_bind in H2.
